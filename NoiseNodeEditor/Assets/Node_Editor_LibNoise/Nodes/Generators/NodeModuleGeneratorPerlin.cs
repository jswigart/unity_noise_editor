...
{
    [System.Serializable]
    [Node(false, "Noise/Generator/Perlin")]
    public class NodeModuleGeneratorPerlin : NodeModuleBase
    {
        public override string GetID { get { return typeof(NodeModuleGeneratorPerlin).Name.ToLower(); } }
        ...
        {
            NodeModuleGeneratorPerlin node = CreateInstance<NodeModuleGeneratorPerlin>();
