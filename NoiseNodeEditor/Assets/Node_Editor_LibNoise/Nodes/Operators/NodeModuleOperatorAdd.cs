...
{
    [System.Serializable]
    [Node(false, "Noise/Operator/Add")]
    public class NodeModuleOperatorAdd : NodeModuleBase
    {
        public override string GetID { get { return typeof(NodeModuleOperatorAdd).Name.ToLower(); } }
                
        Add _module = new Add();

        public NodeModuleOperatorAdd()
        {
            InitModule(_module);
        }
        ...
        {
            NodeModuleOperatorAdd node = CreateInstance<NodeModuleOperatorAdd>();
